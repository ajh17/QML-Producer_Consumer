...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Life_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 15)
    ...
    "Life\0backgroundColorChanged\0\0"
    "backgroundColor\0"
};
...
void Life::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Life::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Life::backgroundColorChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Life::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Life.data,
      qt_meta_data_Life,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Life.stringdata))
        return static_cast<void*>(const_cast< Life*>(this));
...
// SIGNAL 0
void Life::backgroundColorChanged()
{
